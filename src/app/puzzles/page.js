...
export default function PuzzlesPage() {
  ...
  return <main className="flex min-h-screen justify-center bg-zinc-50 px-4 py-6 text-zinc-900"><div className="flex min-h-[850px] w-full max-w-[440px] flex-col overflow-hidden rounded-[40px] border-[8px] border-zinc-100 bg-white shadow-2xl">
    <header className="flex items-center justify-between px-6 pb-3 pt-8"><Link href="/" aria-label="Back home" className="rounded-full p-2 hover:bg-zinc-100"><ChevronLeft/></Link><div className="text-center"><p className="text-[10px] font-bold uppercase tracking-[.2em] text-zinc-400">Global rated puzzles</p><h1 className="text-lg font-black">{puzzle.title}</h1></div><div className="flex items-center gap-1 rounded-full bg-zinc-900 px-3 py-2 text-xs font-black text-white"><Star size={13} className="text-amber-300"/>{rating}</div></header>
