...
import { Activity, ArrowRight, BookOpenCheck, CalendarClock, CheckCircle2, Clock3, LogOut, MessageSquareText, Target, Users } from "lucide-react";
...
export default function StudentDashboard() {
  ...
  return <main className="min-h-screen bg-zinc-50 px-4 py-8 text-zinc-900"><div className="mx-auto w-full max-w-6xl">
    ...
    <nav className="mb-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">{[
      { title: "Homework", href: "/student/homework", icon: CalendarClock }, { title: "Classrooms", href: "/student/classes", icon: Users }, { title: "Coach feedback", href: "/student/feedback", icon: MessageSquareText }, { title: "Puzzle trainer", href: "/puzzles", icon: BookOpenCheck }
